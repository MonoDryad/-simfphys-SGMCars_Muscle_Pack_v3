			...
			},		    
{
		...
		BrakePower = 48, -- If set really high, there's a chance your car will fly over his head
		...
		PeakTorque = 211, -- how fast your wheels spin
...
--
		...
		Gears = {-0.04,0,0.06,0.12,0.18,0.22} -- how many gears do you want?
	}
}
