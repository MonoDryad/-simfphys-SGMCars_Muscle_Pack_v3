local light_table = {
	...
	Rearlight_sprites = {
		Vector(-18.5,-114,37.4),
		Vector(18.5,-114,37.4),
		Vector(-20.5, -114,37.4),
		Vector(20.5, -114,37.4),
		Vector(-22.5, -114,37.4),
		Vector(22.5, -114,37.4),
		Vector(-24.5, -114,37.4),
		Vector(24.5, -114,37.4),
		Vector(-26.5, -114,37.4),
		Vector(26.5, -114,37.4),
		Vector(-28.5, -114,37.4),
		Vector(28.5, -114,37.4),
		Vector(-30.5, -114,37.4),
		Vector(30.5, -114,37.4),
		Vector(-16.5, -114,37.4),
		Vector(16.5, -114,37.4),
		Vector(-14.5, -114,37.4),
		Vector(14.5, -114,37.4),
		Vector(-12.5, -114,37.4),
		Vector(12.5, -114,37.4),
		Vector(-10.5, -114,37.4),
		Vector(10.5, -114,37.4),
		Vector(-32.5, -114,37.4),
		Vector(32.5, -114,37.4),
		Vector(-34.5, -114,37.4),
		Vector(34.5, -114,37.4),
...
list.Set( "simfphys_lights", "1971_javelin", light_table)
...
local V = {
	...
	Members = {
		...
		PassengerSeats = {
		    {
				pos = Vector(16.4,-4,16.5),
				ang = Angle(0,0,12)
			},		    
{
				pos = Vector(17,-40,16.5),
				ang = Angle(0,0,12)
			},
{
				pos = Vector(-17,-40,16.5),
...
if (file.Exists( "models/sentry/javelin.mdl", "GAME" )) then -- name of the model (".mdl")
	list.Set( "simfphys_vehicles", "simfphys_javelin", V ) -- change to any name (for example -  sim_fphys_lalala)
end
